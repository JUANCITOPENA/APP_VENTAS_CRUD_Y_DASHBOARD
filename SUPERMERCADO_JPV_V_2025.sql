...
CREATE DATABASE SUPERMERCADO_JPV_V_2025;
GO

-- Usar la Base de Datos
USE SUPERMERCADO_JPV_V_2025;
GO
...
UPDATE PRODUCTO
SET STOCK = 3000; -- Aquí reemplaza 200 con el valor deseado para el stock
...
-- Actualizar el stock de todos los productos a un valor específico (por ejemplo, x = 200)
UPDATE PRODUCTO
SET STOCK = 50000; -- Aquí reemplaza 200 con el valor deseado para el stock
...
DECLARE @FechaFin DATE = '2025-04-19';
DECLARE @CantidadRegistros INT = 3500; -- Cambiar según la cantidad deseada
...
WHERE TABLE_NAME = 'VISTA_COMPLETA_VENTAS';

SELECT 
    FECHA AS FechaPedidoServerN, 
    CONCAT(Sucursal_Vendedor, ' ', Provincia_Vendedor) AS [Localidad Nombre], 
    CANTIDAD AS Cantidad, 
    INGRESO_TOTAL AS [Total Vendido], 
    VENDEDOR AS Vendedor, 
    ID_PEDIDO AS NoPedidoStr, 
    Cliente AS Cliente, 
    CONCAT('Reclamo por producto: ', Nombre_Producto) AS Descripcion
FROM 
    VISTA_COMPLETA_VENTAS
