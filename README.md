...
✅ Hemos elegido **Microsoft SQL Server**, un sistema de gestión de bases de datos relacionales robusto y escalable, perfecto para manejar los datos de ventas, productos, clientes y más.

### 📚 **¿Qué Contiene?** 

Dentro de `SUPERMERCADO_JPV_V3`, la información está organizada lógicamente en **tablas interconectadas** 🔗. Las tablas principales incluyen:
...
Nuestro backend (`server.js`) utiliza el driver `mssql` para **conectarse de forma segura** a esta base de datos. Es la fuente de la que bebe la API para:
...
El diseño también puede incluir **Triggers** para tareas automáticas, como actualizar el stock de `Productos` cada vez que se inserta una nueva `Venta`.
...
## 🏗️ Construyendo la Experiencia: HTML, CSS y JavaScript Puro

La interfaz que ves es el resultado de la sinergia del trío fundamental de la web:

### 📄 **HTML (`index.html`, `ventas.html`)**

✅ Define la **estructura semántica** del contenido. Son los cimientos: las secciones, los títulos, los contenedores para gráficos, las tablas, los formularios y los botones.

### 🎨 **CSS (`style.css`, `ventas_style.css`)**

✅ Es el **estilista**. Se encarga de toda la apariencia visual:
* ✅ Colores y fuentes
* ✅ Espaciado
* ✅ Diseño responsivo (para que funcione en móviles y escritorio)
* ✅ **Modo oscuro** 🌓
* ✅ Define la personalidad visual de la aplicación

### 🧠 **JavaScript Puro (Vanilla JS - `script.js`, `ventas_script.js`)**

✅ Es el **cerebro interactivo**. Este proyecto se enfoca en usar JavaScript directamente (sin frameworks pesados de frontend) para:
...
✅ `server.js` consulta la base de datos (la vista `NUEVA_VISTA_ANALISIS_VENTAS_v1` para el resumen y las tablas unidas para detalles).

### 🔄 **Procesamiento**

✅ `script.js` recibe estos datos. Realiza agregaciones (ventas por región, por vendedor, etc.) y cálculos clave (crecimiento anual, Pareto A/B/C, KPIs).

### 📈 **Visualización**

✅ Chart.js entra en acción para renderizar:
...
* ✅ Modifica `server.js` para utilizar estas variables:
```javascript
...
#### 🛡️ **Proteger Información Sensible**
...
* ✅ Describe bugs o mejoras propuestas abriendo un [Issue](https://github.com/JUANCITOPENA/APP_VENTAS_CRUD_Y_DASHBOARD/issues).

### 💡 **Sugerir Nuevas Características**

* ✅ Usa también la sección de Issues para proponer ideas.
